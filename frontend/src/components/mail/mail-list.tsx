          ...
          {groups.map((group, index) => {
            ...
            return (
              <button
                ...
                className={cn(
                  "group flex w-full min-w-0 flex-col items-start gap-1.5 border-b border-l-[4px] border-l-transparent px-4 py-3.5 text-left text-sm outline-none transition-colors",
